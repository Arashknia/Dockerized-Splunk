...
3. After installation look for the Splunk/Splunk image from the docker desktop search box and then pull the image with the "latest" tag.
   > To date of this repository, the Splunk version is 9.2.2. I don't predict there will be such a change on Splunk which may cause issues with our configuration otherwise please inform and I will update the repository
